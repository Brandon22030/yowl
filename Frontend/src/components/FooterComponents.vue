<template>
   <div class=" bottom-0 mt-[25rem]">
    <div class="relative mt-16  ">
      <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-white" preserveAspectRatio="none" viewBox="0 0 1440 54">
        <path fill="currentColor" d="M0 22L120 16.7C240 11 480 1.00001 720 0.700012C960 1.00001 1200 11 1320 16.7L1440 22V54H1320C1200 54 960 54 720 54C480 54 240 54 120 54H0V22Z"></path>
      </svg>
      <div class="px-4 pt-12 mx-auto sm:max-w-xl text-white md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div class="md:max-w-md lg:col-span-2">
            <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
                <img src="/images/feedback.png" alt="logo" class="h-[4rem]" />

              <span class="ml-2 text-xl font-bold tracking-wide text-gray-100 uppercase">FOURPARAMS</span>
            </a>
            <div class="mt-4 lg:max-w-sm">
              <p class="text-sm text-deep-purple-50">
                We advocate the expression of freedom, where everyone is free to give their opinion on interesting topics.               </p>
              <p class="mt-4 text-sm text-deep-purple-50">
                Our application brings together people of all backgrounds, regardless of sex, age or nationality.              </p>
            </div>
          </div>
